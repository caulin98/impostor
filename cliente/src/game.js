...
function preload() {
  ...
  this.load.spritesheet("gabe","cliente/assets/images/personaje.png",{frameWidth:15.75,frameHeight:25});
}
...
function update(time, delta) {
  ...
  if (cursors.left.isDown) {
    ...
    if (prevVelocity.x < 0) player.setTexture("gabe", "gate-left-walk");
    else if (prevVelocity.x > 0) player.setTexture("gabe", "gate-right-walk");
    else if (prevVelocity.y < 0) player.setTexture("gabe", "gate-back-walk");
    else if (prevVelocity.y > 0) player.setTexture("gabe", "gate-front-walk");
  }
}
